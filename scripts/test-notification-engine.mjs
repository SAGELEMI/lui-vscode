...
const markup=await readFile(resolve(game,'scripts/Presentation/Components/NotificationOverlay.lui'),'utf8');
const backend=await readFile(resolve(game,'scripts/Presentation/Components/NotificationOverlay.lui.lua'),'utf8');
const files=[];
