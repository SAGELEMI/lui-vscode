...
const tagMap = {
  "lui:Scene": "场景", "lui:Page": "页面", "lui:Component": "组件", "lui:PagePresenter": "页面呈现器", "lui:If": "条件", "lui:For": "重复项", "lui:Slot": "插槽", "lui:Preview": "预览", "lui:Set": "设值",
...
const componentMap = { Header: "页眉", PageShell: "页面外壳", InformationPanel: "信息面板", SelectionList: "选择列表", TabView: "页签视图" };
