...
attributeAliases["悬停背景"] = "HoverBackground"
attributeAliases["按下背景"] = "PressedBackground"
...
attributeAliases["字体"] = "FontFamily"
attributeAliases["字体家族"] = "FontFamily"
attributeAliases["字重"] = "FontWeight"
attributeAliases["字体样式"] = "FontStyle"
attributeAliases["行高"] = "LineHeight"
attributeAliases["字距"] = "LetterSpacing"
attributeAliases["文字换行"] = "TextWrapping"
attributeAliases["文字裁剪"] = "TextTrimming"
attributeAliases["文字描边颜色"] = "TextStrokeColor"
attributeAliases["文字描边宽度"] = "TextStrokeWidth"
attributeAliases["轨道画刷"] = "TrackBrush"
attributeAliases["进度画刷"] = "FillBrush"
attributeAliases["进度方向"] = "ProgressDirection"
    ...
    while offset <= #text do
        ...
        if text:sub(openStart, openStart + 3) == "<!--" then
            ...
            if closing then
                ...
                node.nodePath = parent and (parent.nodePath .. "/" .. tostring(#parent.children + 1)) or "0"
