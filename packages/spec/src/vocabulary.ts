...
export const TAG_TO_CANONICAL: Record<string, string> = {
  ...
  "网格": "Grid", "画布": "Canvas", "视图框": "Viewbox", "堆叠面板": "StackPanel", "换行面板": "WrapPanel", "停靠面板": "DockPanel", "均分网格": "UniformGrid", "边框": "Border", "滚动查看器": "Scroll", "内容控件": "ContentControl", "文本": "Text", "按钮": "Button", "卡片": "Card", "滚动区": "Scroll", "进度条": "Progress", "开关": "Toggle", "滑块": "Slider", "安全区": "SafeArea", "弹窗": "Modal", "分区": "Section", "提示": "Notice", "屏幕": "Screen", "固定屏幕": "FixedScreen",
...
export const CANONICAL_TO_TAG: Record<string, string> = {
  "lui:Page": "页面", "lui:Component": "控件", "lui:If": "条件", "lui:For": "循环", "lui:Slot": "内容呈现器", "lui:Preview": "预览", "lui:Set": "设值",
  Grid: "网格", Canvas: "画布", Viewbox: "视图框", StackPanel: "堆叠面板", WrapPanel: "换行面板", DockPanel: "停靠面板", UniformGrid: "均分网格", Border: "边框", ContentControl: "内容控件", Text: "文本", Button: "按钮", Card: "卡片", Scroll: "滚动查看器", Progress: "进度条", Toggle: "开关", Slider: "滑块", SafeArea: "安全区", Modal: "弹窗", Section: "分区", Notice: "提示", Screen: "屏幕", FixedScreen: "固定屏幕"
};
...
export const ATTRIBUTE_TO_CANONICAL: Record<string, string> = {
  ...
  "宽度": "Width", "高度": "Height", "最小宽度": "MinWidth", "最小高度": "MinHeight", "最大宽度": "MaxWidth", "最大高度": "MaxHeight", "外边距": "Margin", "内边距": "Padding", "裁剪超出": "ClipToBounds",
...
export const ATTRIBUTE_LABELS: Record<string, string> = {
  "x:Name": "名称", "x:DisplayName": "副名称", "x:Ref": "引用", Width: "宽度", Height: "高度", MinWidth: "最小宽度", MinHeight: "最小高度", MaxWidth: "最大宽度", MaxHeight: "最大高度", Margin: "外边距", Padding: "内边距", ClipToBounds: "裁剪超出", RowDefinitions: "行定义", ColumnDefinitions: "列定义", RowSpacing: "行间距", ColumnSpacing: "列间距", "Grid.Row": "网格.行", "Grid.Column": "网格.列", "Grid.RowSpan": "网格.跨行", "Grid.ColumnSpan": "网格.跨列", "Canvas.Left": "画布.左", "Canvas.Top": "画布.上", "Canvas.Right": "画布.右", "Canvas.Bottom": "画布.下", Background: "背景", Color: "颜色", Opacity: "不透明度", BorderRadius: "圆角", Variant: "外观", HorizontalAlignment: "水平对齐", VerticalAlignment: "垂直对齐", Visibility: "可见性", Dock: "停靠", LastChildFill: "最后子项填充", ZIndex: "层级", Text: "文本", Title: "标题", Subtitle: "副标题", FontSize: "字号", Click: "点击", Change: "变更", Submit: "提交", Select: "选择", Open: "打开", Focus: "获得焦点", Blur: "失去焦点", Complete: "完成", DragStart: "拖动开始", DragEnd: "拖动结束", DragCancel: "拖动取消", Close: "关闭", Disabled: "禁用", Value: "值", Max: "最大值", Min: "最小值", Step: "步长", Placeholder: "占位文本", Items: "项目", Data: "数据", Options: "选项", Icon: "图标", Image: "图片", Source: "资源", Orientation: "方向", Columns: "列数", Rows: "行数", Gap: "间距", Type: "类型", Visible: "可见", Test: "条件", In: "集合", Each: "循环项", Path: "路径", Name: "插槽名", Error: "错误", Settings: "设置", Back: "返回", WeaponText: "武器文本", ArmorText: "护甲文本", SelectWeapon: "选择武器", SelectArmor: "选择护甲", CloseOnOverlay: "点击遮罩关闭", ShowCloseButton: "显示关闭按钮", Edges: "安全边", Mode: "安全区模式", NativeMenuInset: "原生菜单安全区"
};
...
export const ATTRIBUTE_DEFINITIONS: Record<string, AttributeDefinition> = {
  ...
  Variant: { kind: "enum", options: ["高亮", "常规"] }, Disabled: { kind: "enum", options: ["是", "否"] }, ClipToBounds: { kind: "enum", options: ["是", "否"], tags: ["lui:Page"] }, CloseOnOverlay: { kind: "enum", options: ["是", "否"] }, ShowCloseButton: { kind: "enum", options: ["是", "否"] }, Visible: { kind: "enum", options: ["是", "否"] }, Visibility: { kind: "enum", options: ["显示", "隐藏", "折叠"] }, HorizontalAlignment: { kind: "enum", options: ["左", "居中", "右", "拉伸"] }, VerticalAlignment: { kind: "enum", options: ["上", "居中", "下", "拉伸"] }, Dock: { kind: "enum", options: ["左", "上", "右", "下"] }, LastChildFill: { kind: "enum", options: ["是", "否"] }, Edges: { kind: "enum", options: ["全部", "无", "水平", "垂直"] }, Mode: { kind: "enum", options: ["内边距", "外边距"] }, NativeMenuInset: { kind: "enum", options: ["是", "否"] }
};
